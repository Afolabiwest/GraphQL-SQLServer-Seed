...
const getTemplate = ( payeeFullname, amount ) => {
...
const sendConsumerReceiptMail = ( recepientEmail, payeeFullname, amount ) => {
	let mailTemplate =  getTemplate( payeeFullname, amount )
	sendGrid.send( recepientEmail, subject, textMsg, mailTemplate );
}
module.exports = sendConsumerReceiptMail;